...
### 6. 温度的微观意义
热力学温度只与平均平动动能有关
   $\displaystyle \begin{cases} p=\frac{R}{N_A}\frac{N}{V}T=\mu kT \\ P=\frac{2}{3}n\overline{\epsilon_k} \end{cases}\Rightarrow\overline{\epsilon_k}=\frac{2}{3}kT \quad T=\frac{2\overline{\epsilon_k}}{3k}$
### 7. 混合气体的压强
   1. 气体分压定律：
