...
##### 2. 折射定律与反射定律:
   ...
   <div  align="center">
   <img src="图片/折射率.png" width="75%" height="75%">
   </div>
   ...
   6. 棱镜折射率的测定（最小偏射角方法） 
      ...
      <div  align="center">
      <img src="图片/最大偏折角.png" width="50%" height="50%">
      </div>
...
#### 3. 费马原理 
   ...
   * 平行光经透镜汇聚于焦点时，波面与焦点之间的光程相等。
   <div  align="center">
   <img src="图片/凸透镜成像光路2.jpeg" width="50%" height="50%">
   </div>
   
   $\Delta \varphi =0,\delta=0\\即各路等光程：L_{SAS'}=L_{SOS'}=L_{SCS'}$

   <div  align="center">
   <img src="图片/凸透镜成像光路1.jpeg" width="50%" height="50%">
   </div>
...
#### 1. 成像的基本概念
   ...
   <div  align="center">
   <img src="图片/单心光束.jpeg" width="75%" height="75%">
   </div>
...
#### 7. 薄透镜成像公式
   ...
   <div  align="center">
   <img src="图片/透镜们.jpg" width="75%" height="75%">
   </div>
...
#### 2. 分波面干涉（杨氏干涉）
   * ##### 杨氏双缝干涉明暗条纹的位置
      ...
      <div  align="center">
      <img src="图片/杨氏双缝干涉.png" width="90%" height="90%">
      </div>
   
      初相差与光程差无关 
      $S_1$与$S_2$关于$S$对称$(\varphi_{10}=\varphi_{20})$且真空$(n_1=n_2)$:
      $\varphi_1-\varphi_2=\frac{2\pi}{\lambda}(n_1r_1-n_2r_2)=\frac{2\pi\delta}{\lambda} \\ \begin{cases} \delta=r_1-r_2\approx d\sin \theta \approx d\tan \theta \\ \tan \theta =\frac{x}{D} \end{cases}\implies $ <font color=red> $\delta =\frac{x}{D}d$ </font>
      $(\delta=n_1r_1-n_2r_2)\begin{cases} \delta=\pm k\lambda=\pm 2k\frac{\lambda}{2}(I_{\max}亮) \\ \delta=\pm (2k+1)\frac{\lambda}{2}(I_{\min}暗) \end{cases}$
---
### 2. 光的衍射
